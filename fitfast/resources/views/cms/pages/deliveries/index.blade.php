...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Deliveries Management</h1>
    <div>
        <a href="{{ route('cms.deliveries.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            <i class="fas fa-plus fa-sm text-white-50"></i> Create Delivery
        </a>
    </div>
</div>
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="{{ route('cms.deliveries.search') }}" method="GET">
            <div class="row">
                <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <a href="{{ route('cms.deliveries.index') }}" class="btn btn-secondary">
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <div class="text-center py-4">
            ...
            <a href="{{ route('cms.deliveries.index') }}" class="btn btn-primary">View All Deliveries</a>
        </div>
        @else
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('cms.orders.show', $delivery->order) }}" class="text-primary">
                        ...
                        <td>
                            <div class="btn-group">
                                @if(!$delivery->isCompleted())
                                    ...
                                    @endif
                                    <form action="{{ route('cms.deliveries.mark-delivered', $delivery) }}" method="POST" class="d-inline">
                                        @csrf
                                ...
                                <form action="{{ route('cms.deliveries.destroy', $delivery) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                    ...
                    <div class="modal fade" id="addTrackingModal{{ $delivery->id }}" tabindex="-1" role="dialog" aria-labelledby="addTrackingModalLabel{{ $delivery->id }}" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('cms.deliveries.add-tracking', $delivery) }}" method="POST">
                                    @csrf
                    ...
                    <div class="modal fade" id="editTrackingModal{{ $delivery->id }}" tabindex="-1" role="dialog" aria-labelledby="editTrackingModalLabel{{ $delivery->id }}" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('cms.deliveries.update-tracking', $delivery) }}" method="POST">
                                    @csrf
                                    <div class="modal-body">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="edit_carrier{{ $delivery->id }}" name="carrier" required>
                                                <option value="">Select Carrier</option>
                                                <option value="UPS" {{ $delivery->carrier == 'UPS' ? 'selected' : '' }}>UPS</option>
                                                <option value="FedEx" {{ $delivery->carrier == 'FedEx' ? 'selected' : '' }}>FedEx</option>
                                                <option value="DHL" {{ $delivery->carrier == 'DHL' ? 'selected' : '' }}>DHL</option>
                                                <option value="USPS" {{ $delivery->carrier == 'USPS' ? 'selected' : '' }}>USPS</option>
                                                <option value="Local Courier" {{ $delivery->carrier == 'Local Courier' ? 'selected' : '' }}>Local Courier</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                    ...
                    <div class="modal fade" id="updateStatusModal{{ $delivery->id }}" tabindex="-1" role="dialog" aria-labelledby="updateStatusModalLabel{{ $delivery->id }}" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('cms.deliveries.update-status', $delivery) }}" method="POST">
                                    @csrf
                                    <div class="modal-body">
                                        <div class="form-group">
